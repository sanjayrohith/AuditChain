...
const features = [
  {
    ...
    description: "Automatically identify and map all AI systems across your organization. Classify use cases by risk level and regulatory impact areas.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Semantic Law Matching",
    description: "Our RAG-powered engine searches across AI regulations to find exactly which laws apply to your systems. No legal expertise required.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Compliance Disclosure Generator",
    description: "Auto-generate complete compliance disclosures and documentation tailored to your AI systems and jurisdiction.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Tamper-Evident Audit Trail",
    description: "Maintain immutable records of all AI decisions with cryptographic verification for regulatory audits and legal protection.",
    visual: "security",
  },
];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            ...
            <br />
            <span className="text-muted-foreground">Designed for simplicity.</span>
          </h2>
        </div>
